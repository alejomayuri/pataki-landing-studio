...
const Prices = () => {
  return (
    <>
      <section
        id="precios"
        className="py-16 md:py-24 bg-background-secondary text-[var(--color-foreground)]"
      >
            ...
            {PLANS.map((plan) => (
              <div
                ...
                className={`rounded-2xl p-6 sm:p-8 border ${
                  plan.highlight
                    ? "bg-gradient-to-br from-[var(--color-galaxy-start)] to-[var(--color-galaxy-end)] border-none text-foreground shadow-xl scale-105"
